...
parser.add_argument('-res_path', type=str, required=True, help='Path to output.')
parser.add_argument('-in_path', type=str, required=True, help='Path to input.')
opt = option.parse(parser.parse_args().opt, is_train=False)
opt = option.dict_to_nonedict(opt)

opt['datasets']['test_1']['dataroot_LR'] = parser.parse_args().in_path
...
opt['path']['results_root'] = parser.parse_args().res_path
